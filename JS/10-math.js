...
// random
console.log('\nrandom');
console.log(Math.random(4), 4** 0.5);
console.log(Math.random(9), 9** 0.5);
console.log(Math.random(81), 81** 0.5);
console.log(Math.random(2), 2 ** 0.5);
console.log(Math.random(13), 13 ** 0.5);
